        ...
        <div className="settlement-container">
          ...
          id === 19 ? (
            <>
              ...
              ></div> : <div className="settlement2"
              >{buildings[id].hexagon_id && buildings[id].slot_id === 2 && <BsHouseFill color={user.user_id === 1 ? "blue" : "red"} />}</div>}
              {(!buildings[id].slot_id) ? <div
                className="settlement-container3"
                onClick={() => handleClick(id, 3)}
              ></div> : <div className="settlement3"
              >{buildings[id].hexagon_id && buildings[id].slot_id === 3 && <BsHouseFill color={user.user_id === 1 ? "blue" : "red"} />}</div>}
              {(!buildings[id].slot_id) ? <div
                className="settlement-container4"
                onClick={() => handleClick(id, 4)}
              ></div> : <div className="settlement4"
              >{buildings[id].hexagon_id && buildings[id].slot_id === 4 && <BsHouseFill color={user.user_id === 1 ? "blue" : "red"} />}</div>}
              {(!buildings[id].slot_id) ? <div
                className="settlement-container5"
                onClick={() => handleClick(id, 5)}
              ></div> : <div className="settlement5"
              >{buildings[id].hexagon_id && buildings[id].slot_id === 5 && <BsHouseFill color={user.user_id === 1 ? "blue" : "red"} />}</div>}
              {(!buildings[id].slot_id) ? <div
                className="settlement-container6"
                onClick={() => handleClick(id, 6)}
              ></div> : <div className="settlement6"
              >{buildings[id].hexagon_id && buildings[id].slot_id === 6 && <BsHouseFill color={user.user_id === 1 ? "blue" : "red"} />}</div>}
              </>
      ...
      <div className="settlements">
          ...
          id === 19 ? (
            <>
              ...
              <div className="settlement5">{buildings[id].hexagon_id && buildings[id].slot_id === 5 && <BsHouseFill color={buildings[id].user_id === 1 ? "blue" : "red"} />}</div>
              <div className="settlement6">{buildings[id].hexagon_id && buildings[id].slot_id === 6 && <BsHouseFill color={buildings[id].user_id === 1 ? "blue" : "red"} />}</div>
              </>
          ) : id === 2 || id === 9 || id === 11 || id === 18 ? (
            <>
              <div className="settlement2">{buildings[id].hexagon_id && buildings[id].slot_id === 2 && <BsHouseFill color={buildings[id].user_id === 1 ? "blue" : "red"} />}</div>
            ...
            <div className="settlement1">{buildings[id].hexagon_id && buildings[id].slot_id === 1 && <BsHouseFill color={buildings[id].user_id === 1 ? "blue" : "red"} />}</div>
          ) : id === 7 ? (
            <div className="settlement3">{buildings[id].hexagon_id && buildings[id].slot_id === 3 && <BsHouseFill color={buildings[id].user_id === 1 ? "blue" : "red"} />}</div>
          ) : id === 13 ? (
            <div className="settlement4">{buildings[id].hexagon_id && buildings[id].slot_id === 4 && <BsHouseFill color={buildings[id].user_id === 1 ? "blue" : "red"} />}</div>
